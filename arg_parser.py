...
parser.add_argument('-sTable','--source-table', help='Table on source database server', required=True)
parser.add_argument('-tTable','--target-table', help='Table on target database server', required=True)
